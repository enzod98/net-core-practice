...
namespace Turnos.Controllers
{
    public class MedicoController : Controller
    {
        ...
        {
            ViewData["ListaEspecialidades"] = 
                new SelectList(_context.Especialidad, "IdEspecialidad", "Descripcion");
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["ListaEspecialidades"] = 
                new SelectList(_context.Especialidad, "IdEspecialidad", "Descripcion", medico.MedicoEspecialidad[0].IdEspecialidad);
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var medicoEspecialidad = 
                        await _context.MedicoEspecialidad.FirstOrDefaultAsync( me => me.IdMedico == id);
        ...
        public string GetHorarioAtencionDesde(int idMedico)
        {
        ...
        public string GetHorarioAtencionHasta(int idMedico)
        {
